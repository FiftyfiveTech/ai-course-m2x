...
## M2X-036 — first dev F1 and prompt iteration, evaluator lineage (2026-08-12, PR #33) — **target not met**

> **Version numbers in this entry are pre-merge.** The prompts it calls `v2` and `v3` are
> `v4.md` and `v5.md` on `main`; `v2`/`v3` there are the builder lineage in the entry above.
> Digests are unchanged (`cc09b2a2b129`, `a4a219d1c013`), so every number still names its text.
